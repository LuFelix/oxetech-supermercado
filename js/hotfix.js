...
// 3. Descomente o bloco de código abaixo para ativar a proteção e o selo de auditoria:
// ==========================================================================
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  if (footer) {
    footer.innerHTML += " • <span style='color: #27ae60; font-weight: bold;'>🛡️ Hotfix Aplicado (Sistema Protegido)</span>";
  }
});
*/
